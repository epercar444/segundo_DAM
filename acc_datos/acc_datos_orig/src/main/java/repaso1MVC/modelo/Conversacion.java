...
public class Conversacion {
	...
	public Conversacion(int id,String pregunta, String respuesta, TipoAgente agente) {
		super();
		this.id = id;
		this.pregunta = pregunta;
		this.respuesta = respuesta;
	...
	public Conversacion(int id, String pregunta, String respuesta, int numValoracionesPositivas,
