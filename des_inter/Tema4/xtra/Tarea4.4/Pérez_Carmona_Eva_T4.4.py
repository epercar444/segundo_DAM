...
# Crear el informe Datapane corregido
reporte = dp.Report(
    dp.Page( #creamos una página asociada al grupo que queremos reunir
        title="Portada",
        blocks=[
    ...
    dp.Page(
        ...
        blocks=[dp.Select(blocks=[grafico_final, grafico_definitivo, grafico_ultimo,data_table])]
    )
)

# Guardar el reporte
reporte.save("organización_grupo.html", open=True)